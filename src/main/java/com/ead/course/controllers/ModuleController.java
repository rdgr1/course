...
public class ModuleController {
    ...
    public ResponseEntity<Page<ModuleModel>> getAllModules(@PathVariable UUID courseId, SpecificationTemplate.ModuleSpec spec, Pageable pageable) {
        return ResponseEntity.status(HttpStatus.OK).body(service.findAllModuleIntoCourse(SpecificationTemplate.moduleCourseId(courseId).and(spec), pageable));
    }
    ...
    public ResponseEntity<?> delete(@PathVariable UUID courseId, @PathVariable UUID moduleId) {
        logger.debug("DELETE deleteModule courseId: {}, moduleId: {}");
    ...
    public ResponseEntity<?> updateModule(@PathVariable UUID courseId, @PathVariable UUID moduleId, @RequestBody @Valid ModuleRecordDto dto) {
        logger.debug("PUT updateModule courdeId: {}, moduleId: {}, ModuleRecordDto: {}", courseId, moduleId, dto);
